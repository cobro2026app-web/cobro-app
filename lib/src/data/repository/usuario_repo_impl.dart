...
class UsuarioRepoImpl
  ...
  @override
  Future<Either<Failure, CobradorEntity>>
      listarCobradores() async {

    try {

      final response =
          await usuarioService.listarCobradores();
  ...
  Future<Either<Failure, dynamic>>
    ...
    try {
      ...
      final response =
          await usuarioService.crearCobrador(
        dto: dto,
      );
